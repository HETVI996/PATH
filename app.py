...
QUESTIONS = [
    ...
    },
    {
        ...
        "number":  5,
        "title":   "Pride project",
        "question": "Which of these best describes a project or accomplishment you're genuinely proud of?",
        "type":    "radio",
        "options": [
            "Built a personal website",
            "Built an automation script",
            "Completed a research mini-project",
            "Completed internship project",
            "Created a mobile app",
            "Designed a prototype model",
            "Led a college event",
            "Organised a social drive",
            "Published a blog series",
            "Won a hackathon",
        ],
    },
    {
        ...
        "number":  6,
        "title":   "Your hobbies",
        "question": "Which group of hobbies feels most like you?",
        "type":    "radio",
        "options": [
            "Art, Sketching, Design",
            "DIY Projects, Robotics",
            "Finance tracking, Investing",
            "Gaming, Streaming, Editing",
            "Podcast listening, Note-taking",
            "Reading, Coding, Chess",
            "Sports, Fitness, Yoga",
    ...
    },
    {
        ...
        "question": "Which of these best describes what leaves you feeling energised and excited?",
        "type":    "radio",
        "options": [
            "Building things keeps me engaged",
            "Collaborative brainstorming energizes me",
            "Creative discussions excite me",
            "Deep focused work energizes me",
            "Exploring new ideas excites me",
            "Helping people gives me energy",
            "Learning new concepts motivates me",
            "Solving complex problems energizes me",
            "Strategic planning excites me",
            "Teaching others feels energizing",
        ],
    },
    {
        "id":      "Friend_Help",
    ...
    },
    {
        ...
        "number":  18,
        "title":   "Job choice",
        "question": "Which statement best describes how you'd choose between two job offers?",
        "type":    "radio",
        "options": [
            "Chose higher salary for security",
            "Chose learning and growth over salary",
            "Chose stability due to family needs",
            "Opted for flexibility and autonomy",
            "Preferred challenging work environment",
            "Preferred remote-friendly role",
            "Preferred work-life balance over pay",
            "Selected mission-driven organization",
            "Selected role aligned with passion",
            "Selected role with long-term impact",
        ],
    },
    {
        "id":      "No_Money_Problem",
        ...
        "question": "If money were no object, what problem would you solve?",
        "type":    "radio",
        "options": [
            ...
            "Improve public safety systems",
            "Reduce digital divide",
            "Reduce unemployment",
            "Solve healthcare affordability",
    ...
    },
    {
        ...
        "question": "At the end of your life, what needs to be true for it to be a success?",
        "type":    "radio",
        "options": [
    ...
    },
    {
        ...
        "question": "Which description best matches your ideal work week?",
        "type":    "radio",
        "options": [
            "Balanced mix of work and learning",
            "Collaborative start, solo execution",
            "Creative work with reviews",
            "Deep work with short meetings",
            "Field work mixed with planning",
            "Flexible schedule with focus blocks",
            "Learning-heavy exploratory week",
            "Mostly independent focused work",
            "Project-driven intense weeks",
            "Structured weekdays, flexible weekends",
        ],
    },
    {
        "id":      "Environment",
    ...
    },
    {
        ...
        "question": "What would a significant failure look like for you?",
        "type":    "radio",
        "options": [
            "Burnout",
            "Ethical compromise",
...
def predict():
    try:
        ...
        data = CustomData(
            ...
            Math             = int(form.get("Math")),
            Language         = int(form.get("Language")),
            Creativity       = int(form.get("Creativity")),
            Management       = int(form.get("Management")),
